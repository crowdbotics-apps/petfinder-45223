"""
Django settings for petfinder_45223 project.
...
ROOT_URLCONF = 'petfinder_45223.urls'
...
WSGI_APPLICATION = 'petfinder_45223.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "petfinder_45223 API",
    "DESCRIPTION": "API documentation for petfinder_45223 App",
    "VERSION": "v1",
}
